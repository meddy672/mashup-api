...
# This function takes in a string representation of a location and cuisine type, geocodes the location, and then pass
#  in the latitude and longitude coordinates to the Foursquare API
def findARestaurant(mealType, location):
    ...
    if result['response']['venues']:
        ...
        # Get a  300x300 picture of the restaurant using the venue_id (you can change this by altering the 300x300
        # value in the URL or replacing it with 'orginal' to get the original picture
